...
const captions = ['Room Interior', 'Bathroom', 'Hotel Corridor', 'Lobby'];
    ...
    <section className="relative">
      ...
      >
        <div className="flex flex-col gap-2">
          <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-[var(--brand-gold)] font-inter">Visual Journey</span>
          <h2 className="text-4xl font-medium font-serif text-[var(--app-text)] m-0 leading-tight">Space & Stillness</h2>
        </div>
        <div className="flex-1 h-px bg-gradient-to-r from-[var(--brand-gold)]/20 to-transparent ml-6" />
      </motion.div>

      {/* Asymmetric grid: first image taller, rest equal */}
        ...
        {displayImages[0] && (
          ...
          >
            <Image
              ...
              alt="Room view"
              fill
              className="object-cover transition-transform duration-[2s] ease-[0.22, 1, 0.36, 1] group-hover:scale-110"
            />
