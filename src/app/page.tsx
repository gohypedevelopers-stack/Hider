  ...
  return (
    <main className="min-h-screen">
      ...
      <Link
        ...
        target="_blank"
        className="fixed bottom-6 right-6 z-50 bg-[#000] text-white rounded-full shadow-2xl flex items-center justify-center hover:scale-105 transition-transform"
        style={{ width: '52px', height: '52px', border: '1px solid #FFF' }}
